...
Model grannyModelAnimate;
// Terrain model instance
Terrain terrain(-1, -1, 200, 4, "../Textures/MapaAlturas1.png");
...
glm::mat4 modelMatrixGranny = glm::mat4(1.0f);
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	// Granny
	grannyModelAnimate.loadModel("../models/Practica4_obj/SportyGranny.fbx");
	grannyModelAnimate.setShader(&shaderMulLighting);
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainBackground("../Textures/Rocas2.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainR("../Textures/Cesped3.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainG("../Textures/Rocas.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainB("../Textures/Cesped2.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
...
void applicationLoop() {
	...
	while (psi) {
		...
		glActiveTexture(GL_TEXTURE0); // <- GLTEXTURE0 con 0 de abajo
		glBindTexture(GL_TEXTURE_2D, textureTerrainBackgroundID);
		...
		// Granny
		modelMatrixGranny[3][1] = terrain.getHeightTerrain(modelMatrixGranny[3][0], modelMatrixGranny[3][2]);
		glm::mat4 modelMatrixGrannyBody = glm::mat4(modelMatrixGranny);
		modelMatrixGrannyBody = glm::translate(modelMatrixGrannyBody, glm::vec3(1.08676, 0.707316, 0.982601));
		modelMatrixGrannyBody = glm::scale(modelMatrixGrannyBody, glm::vec3(0.01, 0.01, 0.01));

		grannyModelAnimate.render(modelMatrixGrannyBody);
